function [zeros,weight] = GaussLegendre(n,sum_weight)
% This function determines the zeros and weights for the
% Gauss-Legendre quadrature of order n>1, in the interval [-1, 1].
%% INPUT: 
...
%% OUTPUT:
%   zeros  - nodes of the Gauss Legendre quadrature rule
%   weight - Weights associated to the nodes=zeros of the Gauss Legendre
%          quadrature rule
%
